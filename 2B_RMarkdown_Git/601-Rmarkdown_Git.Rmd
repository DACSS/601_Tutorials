...
Next, you should watch these helpful videos by Hans Quiogue to get started with Git & Github with RStudio. Even if you're familiar with Git, **please still watch the videos in order**.
...
Notice how anyone who opens up this hypothetical file quickly knows exactly **1)** what data the data the file is analyzing, **2)** what analysis was done, **3)** the original author of the code, and **4)** when the code was last modified. These information saves the user invaluable time, so they can focus on the results of the code and/or modifying the code as they need.
