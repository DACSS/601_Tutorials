...
Within each arithmetic subheader, we include some plain text and some R code. We even name each of our R code chunks (i.e., `arithmetic`, `subtraction`, `multiplication`, and `division`). This can make it easier to navigate our code, as we can use the navigator on the bottom left of the panel to see each of our named code chunks, along with the headers they fall under. If you want to reference an R function or operator in the text, you can do so using backticks. This creates a different looking font that will let the reader know that this is an R function.
